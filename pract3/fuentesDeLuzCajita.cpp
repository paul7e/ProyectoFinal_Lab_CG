...
int main()
{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		//MODELADO BASE SUPERIOR PADRE TOTAL DE LA JERARQUIA DE LA PLATAFORMA
		model = glm::mat4(1.0f);
		model = glm::translate(model, glm::vec3(0.0f, 2.62372f, 0.0f));
		...
		model = glm::mat4(1.0f);
		model = glm::translate(model, glm::vec3(0.0f, 1.82784f, 0.0f));
		...
		model = glm::mat4(1.0f);
		model = glm::translate(model, glm::vec3(0.0f, 2.22578f, 0.0f));
		...
		model = glm::mat4(1.0f);
		model = glm::translate(model, glm::vec3(-3.85684f, 2.21823f, 3.87845f));
		...
		model = glm::mat4(1.0f);
		model = glm::translate(model, glm::vec3(-3.74468f, 2.2322f, 0.0f));
		...
		model = glm::mat4(1.0f);
		model = glm::translate(model, glm::vec3(-3.74468f, 2.2322f, 1.93662f));
		model = glm::scale(model, glm::vec3(0.220f, 0.220f, 0.256f));
		glUniformMatrix4fv(glGetUniformLocation(lightingShader.Program, "model"), 1, GL_FALSE, glm::value_ptr(model));
		...
		model = glm::mat4(1.0f);
		model = glm::translate(model, glm::vec3(0.0f, 2.2322f, 3.74468f));
		model = glm::scale(model, glm::vec3(0.220f, 0.220f, 0.256f));
		glUniformMatrix4fv(glGetUniformLocation(lightingShader.Program, "model"), 1, GL_FALSE, glm::value_ptr(model));
		...
		model = glm::mat4(1.0f);
		model = glm::translate(model, glm::vec3(1.93662f, 2.2322f, 3.74468f));
		model = glm::scale(model, glm::vec3(0.220f, 0.220f, 0.256f));
		glUniformMatrix4fv(glGetUniformLocation(lightingShader.Program, "model"), 1, GL_FALSE, glm::value_ptr(model));
