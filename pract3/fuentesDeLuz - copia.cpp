...
int main()
{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		//MODELADO PARTE BASE DE LA HELICE INFERIOR DE LA CAJITA VOLADORA 
		model = glm::mat4(1.0f);
		model = glm::translate(model, glm::vec3(0.0f, 1.69341f, 0.0f));
		...
		//MODELADO PARTE BASE DE LA HELICE SUPERIOR DE LA CAJITA VOLADORA 
		model = glm::mat4(1.0f);
		model = glm::translate(model, glm::vec3(0.0f, 2.04329f, 0.0f));
		...
		//MODELADO PARTE HELICE DE LA CAJITA VOLADORA
		model = glm::mat4(1.0f);
		model = glm::translate(model, glm::vec3(0.0f, 2.03629f, 0.0f));
		...
		//MODELADO PARTE EXTRA HELICE IZQUIERDA DE LA CAJITA VOLADORA //////////SIEMPRE TRANSLACION ROTACION ESCALA
		model = glm::mat4(1.0f);
		//model = glm::translate(model, glm::vec3(0.839388f, 2.03798f, 0.0f));
		model = glm::translate(model, glm::vec3(0.839388f, 2.03798f, 0.0f));
		...
		// MODELADO OJITOS DE LA CAJITA VOLADORA IZQ //////////SIEMPRE TRANSLACION ROTACION ESCALA ESTA AL REVEZ LOS EJES, ESTE ES EL DERECHO

		model = glm::mat4(1.0f);
		model = glm::translate(model, glm::vec3(0.367371f, 0.62115f, 1.06267f));
		//model = glm::rotate(model, 1.5708f, glm::vec3(0.0f, 1.0f, 0.0f));
		...
		// MODELADO OJITOS DE LA CAJITA VOLADORA DER //////////SIEMPRE TRANSLACION ROTACION ESCALA ESTA AL REVEZ LOS EJES, ESTE ES EL IZQ
		...
		modelMango = glm::translate(modelMango, glm::vec3(-4.0f, 1.93339f, 0.0f));
		model = modelMango;
