...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glUniform3f(glGetUniformLocation(lightingShader.Program, "light.ambient"), 1.0f, 0.0f, 0.0f); //decirle a programa que genere lux ambiental
        ...
        glUniform1f(glGetUniformLocation(lightingShader.Program, "material_shininess"), 1.0f);
